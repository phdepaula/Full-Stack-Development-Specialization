...
def apresentar_automovel(dados_automovel: Automovel, mensagem):
    """ Define um modelo de resposta para quando o automóvel for cadastrado à base de dados.
    """
    result = {
...
def listar_automovel_all (automoveis: List[Automovel]):
    """Define um modelo de resposta para quando for solicitado uma lista dos automóveis cadastrados na base de dados.
    """
    result = []
